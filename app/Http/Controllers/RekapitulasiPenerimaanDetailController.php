...
class RekapitulasiPenerimaanDetailController extends Controller
{
    ...
    public function showForm()
    {
        ...
        return view('page.laporan.rekapitulasi-penerimaan-detail.index', compact('page_title', 'action', 'lokasi'));
    }
    public function handleFormSubmission(Request $request)
    {
        $data = $this->prepareData($request);

        return view('page.laporan.rekapitulasi-penerimaan-detail.data', [
    ...
    public function exportToPdf(Request $request)
    {
        ...
        $file_name = 'Rekapitulasi Penerimaan (Detail) Tanggal ' . $data['tanggal'] . ' di ' . $data['lokasi']->nm_lokasi;
        $pdf = Pdf::loadView('page.laporan.rekapitulasi-penerimaan-detail.export-pdf', [
            'page_title' => $data['page_title'],
            'data_rekap' => $data['data_rekap'],
            'tanggal' => $data['tanggal'],
            'lokasi' => $data['lokasi'],
