                ...
                <div class="table-responsive">
                    <table class="table table-responsive-md table-striped">
                        ...
                        <tbody>
                            ...
                            <!-- <td><strong>{{ number_format($total_seluruh['bbn_pokok'], 0) }} </strong></td>
                            <td><strong>{{ number_format($total_seluruh['bbn_denda'], 0) }} </strong></td> -->
                            <td><strong>{{ number_format($total_seluruh['pkb_pokok'], 0) }} </strong></td>
                            <td><strong>{{ number_format($total_seluruh['pkb_denda'], 0) }} </strong></td>
                            <td><strong>{{ number_format($total_seluruh['swd_pokok'], 0) }} </strong></td>
                            <td><strong>{{ number_format($total_seluruh['swd_denda'], 0) }} </strong></td>
                            <!-- <td><strong>{{ number_format($total_seluruh['opsen_bbn_pokok'], 0) }} </strong></td>
                            <td><strong>{{ number_format($total_seluruh['opsen_bbn_denda'], 0) }} </strong></td> -->
                            <td><strong>{{ number_format($total_seluruh['opsen_pkb_pokok'], 0) }} </strong></td>
                            <td><strong>{{ number_format($total_seluruh['opsen_pkb_denda'], 0) }} </strong></td>
                            <td></td>
                        </tr> --}}
                        </tbody>
                    </table>
