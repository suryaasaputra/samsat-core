                    ...
                    <form action="{{ route('penerimaan-harian.submit') }}" method="post">
                        ...
                        <div class="row d-flex justify-content-center align-items-center">
                            ...
                            <div class="col-12">
                                ...
                                <label class="mb-1" for="kd_wilayah"><strong>Wilayah</strong></label>
                                ...
                                <label class="mb-1"><strong>Jenis Pembayaran</strong></label>
                                <select name="jenis" class="form-control wide" placeholder="Pilih Jenis Pembayaran">
                                    <option value="all">Seluruh</option>
                                    <option value="tunai">Tunai</option>
                                    <option value="nontunai">Non Tunai (QRIS)</option>
                                </select>
