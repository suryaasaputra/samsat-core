            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-12">
                    <form method="post" action="{{ route('bayar') }}" id="form-bayar">
                        @csrf
                        <input type="hidden" name="no_polisi" id="no_polisi" value="{{ $data_kendaraan->no_polisi }}" />
                        <input type="hidden" name="no_trn" id="no_trn" value="{{ $data_kendaraan->no_trn }}" />
                        ...
                        <select class="default-select form-control wide mb-3" name="metode_bayar" tabindex="null">
