                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control no-polisi" name="no_polisi"
                                            placeholder="No Polisi" autofocus="" required="" min="1" maxlength="4"
                                            autocomplete="off" style="text-align: center;">
                                    </div>
                                    <div class="col-lg-2">
                                        <input type="text" class="form-control code-polisi" style="text-align:center;"
                                            maxlength="3" pattern="[A-Z]+" name="seri" placeholder="Seri"
                                            autocomplete="off">
                                    </div>
                                </div>
                            </div>
